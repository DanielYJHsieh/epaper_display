# WiFi E-Paper Display### 📐 智能解析度
```
實體螢幕: 800×480 (GDEQ0426T82)
使用區域: 480×320 (中央顯示，v1.4 升級)
緩衝需求: 19.2KB (安全且高效)
顯示面積: 40% (從 v1.3 的 25% 提升)
```
**ESP8266 無線電子紙顯示系統**

[![Version](https://img.shields.io/badge/version-1.4.0-blue.svg)](https://github.com/DanielYJHsieh/epaper_display)
...
- **Server 端** (PC)：負責圖像處理、智能壓縮、WebSocket 傳輸
- **Client 端** (ESP8266)：負責接收、RLE 解壓、E-Paper 顯示

經過優化，系統使用 **480×320 解析度**，在效能與顯示品質間取得最佳平衡。
...
- **顯示緩衝**: 19.2KB (從 v1.3 的 12KB 提升)
- **安全餘量**: ~8KB (足夠網路操作)
- **總可用**: ~45KB

### 🖼️ 顯示特性
- **解析度**: 480×320 pixels (v1.4 升級)
- **位置**: 螢幕中央
- **更新時間**: ~900ms
- **顯示偏移**: X=160, Y=80
