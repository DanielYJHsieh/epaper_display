...
### 主要程式檔案
- **`GDEQ0426T82_WeMos_D1_Mini.ino`**: 完整功能主程式
- **`GDEQ0426T82_Basic_Test.ino`**: 基本測試程式
- **`GDEQ0426T82_Full_Demo.ino`**: 完整示範程式

### 配置檔案
- **`GxEPD2_display_selection_GDEQ0426T82.h`**: 驅動程式配置檔案

### 功能說明
主程式包含以下測試功能：
1. **🏠 歡迎畫面**: 顯示硬體資訊和狀態
2. **ℹ️ 系統資訊**: ESP8266 詳細資訊和腳位配置  
3. **🎨 圖案測試**: 矩形、圓形、線條、文字等各種圖形
4. **⚡ 部分更新**: 測試快速部分更新功能 (如果支援)
5. **🛠️ 錯誤處理**: 顯示錯誤訊息的功能
